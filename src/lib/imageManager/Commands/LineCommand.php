...
class LineCommand extends \YiiMan\LibUploadManager\lib\imageManager\Commands\AbstractCommand
{
    /**
    ...
    public function execute($image)
    {
        ...
        $line_classname = sprintf('\YiiMan\LibUploadManager\lib\imageManager\%s\Shapes\LineShape',
