...
abstract class AbstractDriver
{
     ...
     *
     * @var \YiiMan\LibUploadManager\lib\imageManager\AbstractDecoder
     */
    public $decoder;
     ...
     *
     * @var \YiiMan\LibUploadManager\lib\imageManager\AbstractEncoder
     */
    public $encoder;
     ...
     * @return \YiiMan\LibUploadManager\lib\imageManager\Commands\AbstractCommand
     */
    ...
    private function getCommandClassName($name)
    {
        ...
        $classnameLocal = sprintf('\YiiMan\LibUploadManager\lib\imageManager\%s\Commands\%sCommand', $drivername, ucfirst($name));
        $classnameGlobal = sprintf('\YiiMan\LibUploadManager\lib\imageManager\Commands\%sCommand', ucfirst($name));
