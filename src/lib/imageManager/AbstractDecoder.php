...
abstract class AbstractDecoder
{
    ...
    public function initFromUrl($url)
    {
        ...
        throw new \YiiMan\LibUploadManager\lib\imageManager\Exception\NotReadableException(
    ...
    /**
     * Determines if current source data is YiiMan\LibUploadManager\lib\imageManager\Image object
     *
     * @return boolean
     */
    public function isInterventionImage()
    {
        return is_a($this->data, '\YiiMan\LibUploadManager\lib\imageManager\Image');
    }
    ...
    /**
     * Initiates new Image from YiiMan\LibUploadManager\lib\imageManager\Image
     *
     * @param  Image $object
     * @return \YiiMan\LibUploadManager\lib\imageManager\Image
     */
    ...
    public function init($data)
    {
        ...
        switch (true) {
            ...
            default:
                throw new Exception\NotReadableException("Image source not readable ,check directory address: ".$this->data);
        }
    }
