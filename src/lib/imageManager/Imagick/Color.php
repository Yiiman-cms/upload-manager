...
namespace YiiMan\LibUploadManager\lib\imageManager\Imagick;

class Color extends \YiiMan\LibUploadManager\lib\imageManager\AbstractColor
{
    /**
     ...
     *
     * @param  int $value
     * @return \YiiMan\LibUploadManager\lib\imageManager\AbstractColor
     */
     ...
     * @return boolean
     */
    public function differs(\YiiMan\LibUploadManager\lib\imageManager\AbstractColor $color, $tolerance = 0)
    {
